...
namespace ContosoInsurance.Helper
{
    /// <summary>
    /// Ref: https://github.com/telerik/UI-For-UWP/blob/master/SDKExamples.UWP/Examples/Chart/AnimationContainerVisualsFactory.cs
    /// </summary>
    public class AnimationContainerVisualsFactory : ContainerVisualsFactory
    {
        ...
        public bool IsAnimationEnabled
        {
            ...
            set => this.isAnimationEnabled = value;
        }
        ...
        private ContainerVisual TriggerSlideAnimation(ContainerVisual colorVisual, int delay, int duration = 100)
        {
